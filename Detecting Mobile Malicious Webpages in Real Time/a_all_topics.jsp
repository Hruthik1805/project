...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h1 align="center" class="style2">View All TOPICS<br />
          (Topics Based on Ranking)</h1>
          <p>&nbsp;</p>
	...
	import="java.util.*,java.security.Key,java.util.Random,javax.crypto.Cipher,javax.crypto.spec.SecretKeySpec,org.bouncycastle.util.encoders.Base64"%>
		...
		try {
			...
			if (rs.next()) 
			{
							...
							%>		<p align="left"> <iframe src="a_all_topics1.jsp" style="border:3px;" width="820" height="600"></iframe> </p>	<%		
						   
			}			   	
		
		     else{
							%> <p align="center">&nbsp;</p>
            <p align="center" class="style5">There is No Added Topics  !!!</p>
            <%		
			     }
