...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html" class="style1 style2">Keyword Search with Access Control<br /> over Encrypted Cloud Data </a></h1>
      </div>
      <div class="menu_nav">
        <ul>
      ...
      <div class="mainbar">
        <div class="article">
		  ...
		  <form name="s" action="au_authentication.jsp" method="post" onSubmit="return valid()"  ons target="_top">  
            <p>&nbsp;</p>
            <div align="center">
    <table border="1" width="51%" height="146">
      <tr>
        <td width="48%" height="25"><span class="style4 style2"><font size="5" face="Courier New, Courier, monospace"> Name</font> </span></td>
        <td width="52%" height="25"><input type="text"  name="userid" size="15" /></td>
      </tr>
      <tr>
        <td width="48%" height="25"><span class="style5 style2"> <font size="5" face="Courier New, Courier, monospace">Pasword</font></span></td>
