...
<% String web=request.getParameter("wb"); %>
          ...
          <h1 align="center" class="style2">VIEW NO.OF TIME ACCESS SPECIFIED MALICIOUS WEBPAGE( <span class="style7"><%=web%></span> ) VIEWED BY A PERTICULAR USER</h1>
          <p>&nbsp;</p>
  
 <p><iframe src="graph4.jsp?wb=<%=web%>" width="500" height="350" style="border:3px;"></iframe></p> 
 
    
			
		  <p>&nbsp;</p>
		  <p align="right"><a href="a_mal_viewed.jsp">Back</a></p>
        </div>
      </div>
      <div class="sidebar">
        <div class="gadget">
