		...
		try 
	         {
				  ...
				  String q2="select * from topics  order by rank DESC LIMIT "+one+""; 
...
<table align="center">
<%
	   if(s33.equalsIgnoreCase(st))
	   {  out.println(count+":MALACIOUS WEBPAGE="+s2+"->Rank="+Rank); %> <br> 
	   <%}
	   else
	   {
%>
              ...
              <tr>
			   ...
			   <tr>
			     ...
			     <td width="200"><span class="style15 style13"> <%=s3%></span></td>
			   </tr>
