...
<head>
<title>All Malicious WebPages</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h1 align="center" class="style2">VIEW ALL MALICIOUS WEBPAGES</h1>
          <p>&nbsp;</p>
	...
	import="java.util.*,java.security.Key,java.util.Random,javax.crypto.Cipher,javax.crypto.spec.SecretKeySpec,org.bouncycastle.util.encoders.Base64"%>
		...
		try {
			...
			if (rs.next()) 
			{
							...
							%>		<p> <iframe src="a_list_mal_webpages1.jsp" style="border:3px;" width="820" height="400"></iframe> </p>	<%		
						   
			}			   	
		
		     else{
							%> <p align="center">&nbsp;</p>
            <p align="center" class="style5">There is No Webpages Added by Attacker  !!!</p>
            <%		
			     }
