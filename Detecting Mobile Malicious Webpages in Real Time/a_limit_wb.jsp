...
<head>
<title>Set Limit to WebPage</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h1 align="center" class="style2">SET LIMIT TO ACCESS MALICIOUS WEBPAGES</h1>
          <p>&nbsp;</p>
		  
<form name="s" action="a_limit_wb_ins.jsp" method="post" onSubmit="return valid()"  ons target="_top">
		 ...
		 <table width="406">
		   <tr>
			  ...
			  <td width="134">  
				   <span class="style10"> Enter Limit </span>
		 ...
		 <tr>
				...
				<td>
                  <p>&nbsp; </p>
                  <p align="center"> <input name="submit" type="submit" value=" Set Limit Access" /> </p>
			    </td>
		 </tr></table> 
          </form>
		  <p align="lsft"><a href="a_view_lim_wb.jsp" class="style12">View All Limit Set Access Malicious WebPages</a></p>
